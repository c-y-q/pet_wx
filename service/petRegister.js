...
exports.addinformations = async (params, petRegId, uuid, orderNum) => {
    ...
    const handleParams = {
        ...
        idNumberPic1: (params.idNumberPic1 &&
                params.idNumberPic1.replace(imgHttp, imgDbPath)) ||
            "",
        idNumberPic2: (params.idNumberPic2 &&
                params.idNumberPic2.replace(imgHttp, imgDbPath)) ||
            "",
        residencePermitPic: (params.residencePermitPic &&
                params.residencePermitPic.replace(imgHttp, imgDbPath)) ||
            "",
        residencePermitPic2: (params.residencePermitPic2 &&
    ...
    const petsql = `INSERT INTO wx_pet_register_info (
                       ...
                       VALUES
                        ...
                        '${handleParams.receiveName}','${handleParams.receivePhone}','${handleParams.receiveAddr}',${handleParams.receive},0,1,${orderNum})`;
